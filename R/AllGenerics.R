...
setGeneric("cnv", function(object) standardGeneric("cnv"))
...
setGeneric("allSubjects", function(object) standardGeneric("allSubjects"))
setGeneric("MAF", function(object) standardGeneric("MAF"))
setGeneric("aTDT", function(object) standardGeneric("aTDT"))
setGeneric("intersect2", function(object) standardGeneric("intersect2"))
setGeneric("TrivialGRangesList", function(object) standardGeneric("TrivialGRangesList"))
setGeneric("CNVMatrix", function(object, gr) standardGeneric("CNVMatrix"))
