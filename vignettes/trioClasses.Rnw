...
aTDT(geno[,1:10])
@ 
This function is not working yet.  It requires the subset method ``]'' be written fro SNPTrioExperiment first.  As it is now the second argument, the GRanges object, is ignored.
<<transcount>>=
TransCount(ste,gr[51:100])
@ 
\clearpage
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
