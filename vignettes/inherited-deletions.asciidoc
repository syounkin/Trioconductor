...
<<chr7, fig = TRUE, echo = FALSE, cache = FALSE, width = 12, height = 6>>=
chr <- 7
wd <- 100e3
...
<<chr7pdf, echo = FALSE, cache = FALSE, results = hide>>=
...
<<chr8, fig = TRUE, echo = FALSE, cache = FALSE, width = 12, height = 6>>=
chr <- 8
...
<<chr8pdf, echo = FALSE, cache = FALSE, results = hide>>=
...
TU.mat <- TU.mat[dist.vec > 1e6,]
ci.mat.cleft <- ci.mat.cleft[dist.vec > 1e6,]
ci.mat.con <- ci.mat.con[dist.vec > 1e6,]
DF <- DF[dist.vec > 1e6,]
