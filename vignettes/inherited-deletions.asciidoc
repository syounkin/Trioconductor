...
<<package, echo = TRUE, eval = FALSE, cache = FALSE>>=
library("trioClasses")
...
<<reload0, echo = FALSE, eval = FALSE>>=
source("~/trioClasses/R/reload.R")
reload("trioClasses")
@
...
<<trioStates2, eval = TRUE, echo = FALSE, results = verbatim, cache = FALSE>>=
trans.mat <- c()
