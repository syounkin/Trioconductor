...
<<cifigcleft, fig = TRUE, cache = FALSE, echo = TRUE>>=
...
@
<<cifigcon, fig = TRUE, cache = FALSE, echo = TRUE>>=
...
lines( rep(8,2), c(0,1), lty = 3 )
@
<<cifigall, fig = TRUE, cache = FALSE, echo = TRUE>>=
...
which(o==32)
@
<<cifig1, fig = TRUE, width = 5, height = 5, echo = TRUE>>=
eps <- 0.05
...
<<disthist, fig = TRUE, echo = TRUE, height = 4, width = 4>>=
...
<<disthistpdf, echo = TRUE, results = hide>>=
...
<<disttrans, fig = TRUE, width = 12, height = 6, echo = TRUE>>=
...
<<filterout, fig = TRUE, height = 6, width = 6, echo = TRUE>>=
...
<<filteroutpdf, echo = TRUE, results = hide>>=
...
<<cifigcleftnew, fig = TRUE, cache = FALSE, echo = TRUE, results = hide, height = 8, width = 10>>=
...
<<ingoplotreg, echo = TRUE, results = hide>>=
...
<<ingoplotcmp, echo = TRUE, results = hide>>=
