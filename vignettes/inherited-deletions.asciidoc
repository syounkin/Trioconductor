...
system("R CMD INSTALL ~/jhsph/R/packages/CleftCNVAssoc")
...
cnv.obj.beaty$cnv.mat <- matrix(0,nrow=length(ids.with.no.deletion.beaty),ncol=ncol(cnv.obj.beaty$cnv.mat),dimnames=list(ids.with.no.deletion.beaty,colnames(cnv.obj.beaty$cnv.mat)))
cnv.obj.pitt$cnv.mat <- matrix(0,nrow=length(ids.with.no.deletion.pitt),ncol=ncol(cnv.obj.pitt$cnv.mat),dimnames=list(ids.with.no.deletion.pitt,colnames(cnv.obj.pitt$cnv.mat)))
...
<<options, echo=FALSE, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<FamilyExperiment, echo = TRUE, eval = FALSE, cache = FALSE>>=
...
@ 
<<freq-vec, echo = TRUE, eval = FALSE, cache = FALSE>>=
...
<<trioStates, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
@ 
<<table-list, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<TU, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<hist, fig = TRUE, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<fish, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<length1, echo = TRUE, eval = FALSE, cache = FALSE>>=
c(length(DF$grange),length(reduce(DF$grange)))
@ 

=== Figures ===

<<qqplot, fig = TRUE, eval = FALSE, echo = TRUE, cache = FALSE>>=
n <- nrow(DF)
...
<<pmin, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<meta, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
@
<<tophits, eval = FALSE, echo = TRUE, cache = FALSE>>=
head(as(regions.gr[order(values(regions.gr)$p.min)],"data.frame"),25)
@ 
<<transvp, fig = TRUE, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
@ 
<<chr16, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<transvp2, fig = TRUE, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
@ 
<<cumsum, fig = TRUE, width = 8, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
axis(2)
@ 
<<transmedianhist, fig = TRUE, eval = FALSE, echo = TRUE, cache = FALSE>>=
with(as(values(regions.gr),"data.frame"),hist(trans.median))
@ 
<<thresh, echo = TRUE, cache = FALSE, eval = FALSE>>=
...
<<trioStates2, eval = FALSE, echo = TRUE, results = verbatim, cache = FALSE>>=
trans.mat <- c()
...
<<trioStates3, eval = FALSE, echo = TRUE, results = verbatim, cache = FALSE>>=
trans.mat.clp <- c()
...
<<transrate, echo = TRUE, eval = FALSE, cache = FALSE>>=
...
<<testable, cache = FALSE, results = verbatim, eval = FALSE>>=
TU.mat <- trans.mat
testable <- which(   (rowSums(TU.mat[,1:2])>=25) & (rowSums(TU.mat[,3:4])>=25) )
TU.mat <- TU.mat[testable,]
trans.mat.clp <- trans.mat.clp[testable,]
@
<<testable2, echo = TRUE, eval = FALSE, cache = FALSE>>=
...
<<headtrans, eval = FALSE, echo = TRUE, cache = FALSE>>=
...
<<transhist, fig = TRUE, cache = FALSE,  height=6, width = 6, eval = FALSE, echo = TRUE, results = hide >>=
par(bg="white")
...
lines( rep(8,2), c(0,1), lty = 3 )
@
<<chr7ci, eval = FALSE, echo = TRUE, results = hide>>=
...
which(o==32)
@
<<cifig1, fig = TRUE, width = 5, height = 5, echo = TRUE, eval = FALSE>>=
eps <- 0.05
...
<<filtercmp, echo = TRUE, eval = FALSE>>=
