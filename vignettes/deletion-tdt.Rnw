...
hist(est.vec, breaks = 20, xlim = c(0,1), ylim = c(0,200), main = "Cleft Trios", xlab = "Transmission Rate", col='darkblue')
...
<<transmission-rate>>=
mean(est.vec[subjectHits(findOverlaps(reduce(locus), cnv.beaty.obj$cmp.gr))])
